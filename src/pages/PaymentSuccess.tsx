...
const PaymentSuccess: React.FC = () => {
  ...
  const { application, paymentReference, isPhD } = location.state || {};
        ...
        {isPhD && (
          <div className="mb-6 p-4 bg-yellow-50 rounded">
            <h3 className="font-semibold text-yellow-800 mb-2">
              Important: Reference Forms
            </h3>
            <p className="text-sm text-yellow-700">
              Please sign in to check if your referees have completed their forms.
              You can track the status of your reference forms in your dashboard.
            </p>
          </div>
        )}
